...
public class Jpfw3cXmlUtil {
	...
	public static Element getRootElement(String in_FileName) throws Exception {
		// System.out.println(in_FileName);
	...
	/**
	 * // 过滤非法字符 // 注意，以下正则表达式过滤不全面，过滤范围为 // 0x00 - 0x08 // 0x0b - 0x0c // 0x0e -
	 * 0x1f
	 * 
	...
	public static void stripNonValidXMLChars(String strFileName) throws Exception {
		...
		String strData = JpfFileUtil.getFileTxt(strFileName, JacocosUtil.EnCoding);

		if (strData == null || "".equals(strData)) {
			return;
		}
		strData = strData.replaceAll("[\\x00-\\x08\\x0b-\\x0c\\x0e-\\x1f]", "");
		JpfFileUtil.saveFile(strFileName, strData, JacocosUtil.EnCoding);
